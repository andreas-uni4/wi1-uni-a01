...
\addcontentsline{toc}{section}{Aufgabe 1.1: Augmented Reality}
\subsection*{\label{sub:thema}a.) Was ist Augmented Reality und wie ist der Begriff entstanden?}
\addcontentsline{toc}{subsection}{a.) Was ist Augmented Reality und wie ist der Begriff entstanden}
...
\addcontentsline{toc}{subsection}{b.) Unsere eigene Definition von Augmented Reality}
...
\addcontentsline{toc}{subsection}{c.) Welche Ausprägungen und Abwandlungen gibt es?}
...
\addcontentsline{toc}{subsection}{d.) Wie wird sich der Bereich in der Zukunft entwickeln?}
...
\addcontentsline{toc}{section}{Aufgabe 1.2: Unterschiede und Gemeinsamkeiten beim Verständnis von Wirtschaftsinformatik}
\subsection*{\label{sub:einfuehrung}a.) Kriterien für einen Vergleich}
\addcontentsline{toc}{subsection}{a.) Kriterien für einen Vergleich}
...
\addcontentsline{toc}{subsection}{b.) Vergleich von den Zeitschriften HMD und BISE}
...
\addcontentsline{toc}{subsection}{c.) Vergleich von den Zeitschriften MISQE und ISR}
...
\addcontentsline{toc}{subsection}{d.) Vergleich von den Veröffentlichungen aus Deutschland (HMD und BISE) mit denen aus dem internationalen bzw. anglo-amerikanischen Bereich (MISQE und ISR)}
...
\addcontentsline{toc}{section}{Bonusaufgabe}
...
\newpage
\addcontentsline{toc}{subsection}{Stellenangebot}
\begin{figure}[htbp]
